...
Vous pouvez commencer ici sans avoir suivi les ateliers de développement. Pour ce premier travail, il suffit de savoir ouvrir des fichiers et lire un tableau. Nous n’installerons rien et nous n’aurons besoin d’aucun compte d’assistant. Les fichiers fournis nous permettront d’abord de comprendre la tâche, puis de reconnaître un résultat utile lorsque nous la confierons à un outil.
