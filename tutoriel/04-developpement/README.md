# Partie 4 — Développer avec une IA

[Sommaire global](../../SOMMAIRE.md) · [Lire les ajouts dans l’ordre](LECTURE.md) · [Détail de la partie](SOMMAIRE.md)

**État : trois nouveaux chapitres présents et à relire ; six chapitres précédemment rédigés encore à importer.** Voir [l’inventaire](../../docs/etat-des-contenus.md).
...
```bash
python tutoriel/04-developpement/integrer.py --partie4 /chemin/vers/partie-4 --sortie /chemin/vers/partie-4-revisee
```
