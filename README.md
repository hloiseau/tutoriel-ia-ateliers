...
**[Ouvrir le sommaire](SOMMAIRE.md)** · **[Voir ce qui est disponible](docs/etat-des-contenus.md)** · **[Lire les derniers chapitres](tutoriel/07-ia-maison/LECTURE.md)**
...
Les **sept premières parties** sont désormais réunies ici : **49 chapitres et deux annexes, 175 sections et 42 illustrations**, avec les ateliers et les documents de reprise. Le [sommaire](SOMMAIRE.md) mène directement aux lectures par chapitre. La partie 8 reste au stade du plan ; le billet d’origine est un contenu séparé.
...
Les [archives d’import ZdS](telechargements/zds/README.md) contiennent les parties 1 à 7 et les annexes dans un ZIP séparé.

Vous pouvez cloner ce dépôt ou télécharger son archive ZIP depuis GitHub. Les [archives des six ateliers](telechargements/) permettent de télécharger un atelier séparément. Le chapitre peut pointer vers une révision précise du dépôt pour conserver les mêmes fichiers au fil des corrections. Les fichiers de poids du modèle local et les exécutables de llama.cpp se téléchargent séparément.
...
Les six ZIP sont écrits dans `telechargements/`. Ils contiennent le code, les résultats de référence et les mentions de licence.
