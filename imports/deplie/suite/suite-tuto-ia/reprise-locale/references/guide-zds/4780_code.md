...
La liste des langages supportés est celle de **pygment**, vous la trouverez [ici](https://pygments.org/languages/ "Langages pygment"). Les mots-clés à insérer pour déclencher la coloration sont les « short names » disponibles sur [cette page](https://pygments.org/docs/lexers/ "Mots-clé pygment").
