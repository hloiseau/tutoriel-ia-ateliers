...
Utiliser `partie-3-zds-v1.zip`, avec le manifeste à la racine. Sélectionner la même archive dans les champs d’import du contenu et des images. Les références `image:images/...` servent à l’import des images dans la galerie.
