...
Les fichiers de référence sont issus d’exécutions réelles sous Linux avec Python 3.12.14 ; voir les journaux et limites de validation dans le dossier `verification` de l’archive principale. Les temps ne sont pas garantis sur une autre machine.
